def main():
    ...
    from transformers import TrOCRProcessor, CanineTokenizer

    processor = TrOCRProcessor.from_pretrained('microsoft/trocr-small-handwritten')
    processor.tokenizer = CanineTokenizer.from_pretrained('google/canine-c')
    config = SinusoidalVisionEncoderDecoderConfig.from_pretrained('microsoft/trocr-small-handwritten', enc_lpe=False, dec_lpe=False, image_height=384, image_width=384, max_length=128)
