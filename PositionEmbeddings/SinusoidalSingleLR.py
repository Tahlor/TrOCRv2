...
def train():
    ...
    model = SinusoidalVisionEncoderDecoder.from_pretrained('../Results/results/SinusoidalTraining/SinusoidalSingle45', config=config, ignore_mismatched_sizes=False)
    ...
    optimizer = AdamW(model.parameters(), lr=5e-5 / (2048 / batch_size))
    ...
    for epoch in range(50):  # loop over the dataset multiple times
        ...
        if epoch % 5 == 0:
            model.save_pretrained(root_directory + "SinusoidalSingleLR" + str(epoch))
    print(losses)
