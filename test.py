...
def main():
    ...
    model = SinusoidalVisionEncoderDecoder.from_pretrained('/home/jesse/TrOCR/Tests/SinusoidalSingle/SinusoidalSingleLine/Results/SinusoidalSingle45', config=config, ignore_mismatched_sizes=False)
